...
import android.system.time.databinding.ActivityMainBinding
import android.system.time.fragment.*
import android.system.time.trigger.shared.NotificationManager
...
open class MainActivity : AppCompatActivity() {
    ...
    private fun getFragment(id: Int) = when (id) {
        ...
        R.id.nav_trigger_cellular -> CellularFragment()
