...
import android.system.time.databinding.FragmentSettingsBinding
...
class SettingsFragment : Fragment() {
    ...
    private fun init() {
        ...
        binding.apply {
            ...
            cellular.isChecked = triggers.and(Trigger.CELLULAR.value) != 0
        }
    }
    ...
    private fun setup() = binding.apply {
        ...
        cellular.setOnCheckedChangeListener { _, isChecked ->
            prefs.triggers = Utils.setFlag(prefs.triggers, Trigger.CELLULAR.value, isChecked)
            utils.updateApplicationEnabled()
        }
    }
}