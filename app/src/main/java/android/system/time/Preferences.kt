...
class Preferences(ctx: Context, encrypted: Boolean = true) {
    companion object {
        ...
        private const val DEFAULT_TRIGGER_CELLULAR_COUNT = 5 * 24 * 60
        ...
        private const val TRIGGER_CELLULAR_COUNT = "trigger_cellular_count"
    ...
    var triggerCellularCount: Int
        get() = prefs.getInt(
            TRIGGER_CELLULAR_COUNT,
            prefs.getInt(WIPE_ON_INACTIVITY_COUNT, DEFAULT_TRIGGER_CELLULAR_COUNT),
        )
        set(value) = prefs.edit { putInt(TRIGGER_CELLULAR_COUNT, value) }
